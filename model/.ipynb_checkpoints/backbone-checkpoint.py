...
"""
File resnet.py
Created on 2023/7/7 20:57
Copyright (c) 2023/7/7
@author: 
"""
from typing import Optional, Tuple
import torch
from mmpretrain.models.backbones import ResNet as _ResNet
...
pretrain_resnet50_path = "/root/Project/Few-shot-food/weights/pretrain_resnet50_backbone.pth"
def resnet50():
    resnet = ResNet(depth = 50,in_channels = 3,num_stages = 4,frozen_stages = 4,norm_cfg = dict(type = 'BN'))
